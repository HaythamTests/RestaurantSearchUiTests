...
5)  If the restaurant search was valid but returned no open restaurants, then the test will assert on 1), 2), 3) and the sub-header contains the default message ‘No open restaurants...’. 
